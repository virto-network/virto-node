...
The `virto-node` project is an **OPENISH Open Source Project**
...
We are organizing issues in https://github.com/virto-network/virto-node/issues[issues]. Best way to get started is to start a discussion on any issue for guidance on how to solve them.
