...
function registerParachainOnLocalRelay(chain_id, genesisHead, validationCode) {
  return new Promise(async (resolve) => {
    ...
    const proposal = api.tx.parasSudoWrapper.sudoScheduleParaInitialize(chain_id, {
      genesisHead,
      validationCode,
      parachain: true,
    });
...
async function registerParachainOnRococo(chain_id, genesisHead, validationCode) {
  ...
  return api.tx.parasSudoWrapper
    .sudoScheduleParaInitialize(chain_id, { genesisHead, validationCode, parachain: true })
