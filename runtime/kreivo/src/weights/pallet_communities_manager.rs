...
impl<T: frame_system::Config> pallet_communities_manager::WeightInfo for WeightInfo<T> {
	...
	fn register() -> Weight {
		...
		Weight::from_parts(164_491_000, 0)
	...
	fn create_memberships(q: u32, ) -> Weight {
		...
		// Minimum execution time: 113_569_000 picoseconds.
		Weight::from_parts(117_430_000, 0)
			.saturating_add(Weight::from_parts(0, 3547))
			// Standard Error: 273_329
			.saturating_add(Weight::from_parts(84_131_631, 0).saturating_mul(q.into()))
