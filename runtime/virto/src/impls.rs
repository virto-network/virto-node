	...
	fn filter(&self, c: &RuntimeCall) -> bool {
		match self {
			...
			ProxyType::AssetOwner => matches!(
				c,
				RuntimeCall::Assets(VirtoAssetsCall::create { .. })
					| RuntimeCall::Assets(VirtoAssetsCall::start_destroy { .. })
					| RuntimeCall::Assets(VirtoAssetsCall::destroy_accounts { .. })
					| RuntimeCall::Assets(VirtoAssetsCall::destroy_approvals { .. })
					| RuntimeCall::Assets(VirtoAssetsCall::finish_destroy { .. })
					| RuntimeCall::Assets(VirtoAssetsCall::transfer_ownership { .. })
					| RuntimeCall::Assets(VirtoAssetsCall::set_team { .. })
					| RuntimeCall::Assets(VirtoAssetsCall::set_metadata { .. })
					| RuntimeCall::Assets(VirtoAssetsCall::clear_metadata { .. })
					| RuntimeCall::Utility { .. }
					| RuntimeCall::Multisig { .. }
			),
			ProxyType::AssetManager => matches!(
				c,
				RuntimeCall::Assets(VirtoAssetsCall::mint { .. })
					| RuntimeCall::Assets(VirtoAssetsCall::burn { .. })
					| RuntimeCall::Assets(VirtoAssetsCall::freeze { .. })
					| RuntimeCall::Assets(VirtoAssetsCall::thaw { .. })
					| RuntimeCall::Assets(VirtoAssetsCall::freeze_asset { .. })
					| RuntimeCall::Assets(VirtoAssetsCall::thaw_asset { .. })
					| RuntimeCall::Utility { .. }
					| RuntimeCall::Multisig { .. }
			),
