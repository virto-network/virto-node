...
use frame_support::{
	...
	parameter_types,
	traits::{ConstU32, ConstU64, ConstU8, Contains, EitherOfDiverse},
...
pub use sp_runtime::{DispatchResult, MultiAddress, Perbill, Permill};
...
pub use parachains_common::{
	opaque, AccountId, AuraId, Balance, BlockNumber, Hash, Header, Index, Signature, AVERAGE_ON_INITIALIZE_RATIO, DAYS,
...
pub const VERSION: RuntimeVersion = RuntimeVersion {
	// spec_name and impl_name must be configured with the runtime name
