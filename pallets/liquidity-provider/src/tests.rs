...
fn attest_increases_asset_supply() {
    new_test_ext().execute_with(|| {
        ...
        assert_ok!(TestProvider::attest(Origin::signed(2), (), 123));
        assert_ok!(TestProvider::attest(Origin::signed(3), (), 456));
        assert_eq!(Tokens::total_issuance(()), 579);
    });
}
...
fn only_providers_can_attest() {
    new_test_ext().execute_with(|| {
        ...
        assert_noop!(
            TestProvider::attest(Origin::signed(2), (), 123),
